...
import { FaArrowLeft, FaSave, FaImage, FaMapMarkerAlt, FaGlobe } from "react-icons/fa";
        ...
        <form onSubmit={handleSubmit} className="premium-form">
          <section className="form-grid">
            <div className="form-group full">
              ...
              <input name="name" value={eventData.name} onChange={handleChange} required placeholder="e.g. Wahap Grand Festival" />
            </div>
            ...
            <div className="form-group">
              ...
              <input name="city" value={eventData.city} onChange={handleChange} required placeholder="e.g. Hyderabad" />
            </div>

            <div className="form-group full">
              <label><FaMapMarkerAlt /> Venue Address</label>
              <input name="address" value={eventData.address} onChange={handleChange} placeholder="Full address of the venue" />
            </div>
            ...
            <div className="form-group">
              ...
              <input name="ageLimit" value={eventData.ageLimit} onChange={handleChange} placeholder="e.g. 18" />
            </div>

            <div className="form-group">
              <label><FaGlobe /> Language</label>
              <input name="language" value={eventData.language} onChange={handleChange} placeholder="e.g. Hindi, English" />
            </div>

            <div className="form-group full">
              <label>About the Event</label>
              <textarea name="aboutEvent" value={eventData.aboutEvent} onChange={handleChange} rows="5" placeholder="Describe the spectacular experience attendees will have..." />
            </div>
          </section>
